...
export default function NavbarProtegido({
  ...
  return (
    <>
      <style>{`.nav-title{font-size:15px;font-weight:700;text-decoration:none}.nav-extra-link{font-size:12px;font-weight:500;color:#5F5E5A;text-decoration:none;padding:5px 10px;border-radius:6px;border:1px solid #B5D4F4;background:transparent;white-space:nowrap}.nav-extra-link:hover{color:#185FA5;border-color:#185FA5}.nav-cerrar{}.nav-volver{}@media(max-width:540px){.nav-title{font-size:13px}.nav-cerrar{display:none!important}.nav-extra-link{display:none!important}}`}</style>
