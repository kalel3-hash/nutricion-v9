...
export default function NavbarProtegido({
  ...
  const navItems: NavItem[] = [
    ...
    { type: "link", label: "Historial Clínico", href: "/historial-clinico" },
    {
      type: "dropdown",
      label: "Medicamentos",
      items: [
      ...
      <nav ref={navRef} style={{ display: "grid", gridTemplateColumns: "auto 1fr auto", alignItems: "center", padding: "0.3rem 1.25rem", background: "#FFFFFF", borderBottom: "1px solid #B5D4F4", position: "sticky", top: 0, zIndex: 50, gap: "8px" }}>
        ...
        {mobileOpen && (
          <div className="nav-mobile-panel">
            ...
            <Link href="/historial-clinico" className={`nav-mobile-link${isActivePath("/historial-clinico") ? " active" : ""}`} onClick={() => setMobileOpen(false)}>
              Historial Clínico
            </Link>
