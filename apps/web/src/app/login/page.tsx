    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Analizá cualquier alimento considerando tus marcadores clínicos reales: colesterol, glucemia, función renal, medicamentos y más. La IA evalúa cada consulta según tu perfil de salud único.
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", position: "relative", zIndex: 1 }}>
          {[
            ...
            "Basado en tus estudios clínicos",
            "OCR automático de PDF de laboratorio",
          ].map((item) => (
      ...
      <div style={{
        ...
        <form action={credentialsSignIn} style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "1.25rem" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <label style={{ fontSize: "0.875rem", fontWeight: 500, color: "#2C2C2A" }}>
              Email
            </label>
            <input
