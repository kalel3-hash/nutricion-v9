...
const sections = [
  { n: "1", title: "Identificacion del titular", content: "El presente sitio web y la plataforma VitalCross AI, accesible desde https://www.vitalcrossai.com.ar, es operado por VitalCross AI (en adelante, la Plataforma).\n\nContacto oficial: info@vitalcrossai.com.ar" },
  { n: "2", title: "Objeto", content: "Estos Terminos y Condiciones regulan el acceso y uso de la Plataforma, cuyos servicios consisten en la provision de informacion nutricional orientativa, generada mediante inteligencia artificial, basada en los datos ingresados voluntariamente por el usuario." },
  { n: "3", title: "Aceptacion", content: "El uso de la Plataforma implica la aceptacion expresa, libre e informada de estos Terminos.\n\nSi el usuario no acepta estos terminos, debera abstenerse de utilizar los servicios." },
  { n: "4", title: "Naturaleza del servicio - No asesoramiento medico", content: "VitalCross AI no presta servicios medicos. La informacion generada por la Plataforma:\n\n• No constituye diagnostico medico\n• No constituye tratamiento\n• No constituye prescripcion ni recomendacion medica\n• No reemplaza la consulta con profesionales de la salud\n\nEl Usuario reconoce que toda decision relacionada con su salud debera ser consultada con un profesional medico o de la salud matriculado.", highlight: true },
  { n: "5", title: "Uso de inteligencia artificial", content: "VitalCross AI utiliza sistemas de inteligencia artificial para analizar informacion ingresada por el usuario y cruzarla con conocimiento nutricional y cientifico general.\n\nEl Usuario acepta que:\n\n• Los resultados son estimaciones informativas\n• Pueden existir errores, omisiones o imprecisiones\n• La IA no actua como profesional humano\n• La informacion es orientativa y no vinculante" },
  { n: "6", title: "Obligaciones del Usuario", content: "El Usuario se compromete a:\n\n• Proporcionar informacion veraz y actualizada\n• Utilizar la Plataforma de manera responsable\n• No utilizar la informacion con fines medicos sin asesoramiento profesional\n• No utilizar la Plataforma para fines ilicitos" },
  { n: "7", title: "Responsabilidad y limitacion", content: "VitalCross AI no sera responsable por:\n\n• Danos derivados del uso o interpretacion de la informacion\n• Decisiones tomadas exclusivamente en base al contenido generado\n• Consecuencias de salud derivadas del uso de la Plataforma\n\nEl uso del servicio es bajo exclusiva responsabilidad del Usuario." },
  { n: "8", title: "Disponibilidad y modificaciones", content: "La Plataforma podra modificar funcionalidades, suspender servicios y actualizar contenidos sin necesidad de previo aviso.\n\nNo se garantiza disponibilidad continua e ininterrumpida." },
  { n: "9", title: "Propiedad intelectual", content: "Todos los contenidos, marcas, textos, logos, graficos y funcionalidades pertenecen a VitalCross AI o sus licenciantes.\n\nQueda prohibida su reproduccion sin autorizacion expresa." },
  { n: "10", title: "Legislacion aplicable y jurisdiccion", content: "Estos Terminos se rigen por las leyes de la Republica Argentina.\n\nCualquier controversia sera sometida a los tribunales competentes." },
    ...
    <div style={{ minHeight: "100vh", background: "#F0F6FF", fontFamily: "system-ui, sans-serif" }}>
      ...
      <section style={{ background: "linear-gradient(135deg, #0C447C 0%, #185FA5 60%, #378ADD 100%)", padding: "3rem 2rem 2.5rem", textAlign: "center" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <h1 style={{ margin: "0 0 0.75rem", color: "#FFFFFF", fontWeight: 800, fontSize: "clamp(1.5rem, 4vw, 2.25rem)", lineHeight: 1.15 }}>Terminos y Condiciones de Uso</h1>
