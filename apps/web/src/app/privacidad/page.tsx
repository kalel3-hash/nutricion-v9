...
const sections = [
  {
    n: "1", title: "Principios generales",
    content: "VitalCross AI se compromete a proteger la privacidad y los datos personales de sus usuarios conforme a la Ley 25.326 de Proteccion de Datos Personales de la Republica Argentina.",
  },
  {
    n: "2", title: "Datos recopilados",
    content: "La Plataforma puede recopilar:\n\n• Datos personales (edad, sexo, peso, altura)\n• Informacion de salud ingresada voluntariamente\n• Datos clinicos y de laboratorio\n• Informacion tecnica basica (navegador, dispositivo)",
  },
  {
    n: "3", title: "Finalidad del tratamiento",
    content: "Los datos son utilizados unicamente para:\n\n• Generar analisis nutricionales personalizados\n• Mejorar la experiencia de uso\n• Garantizar el funcionamiento tecnico",
  },
  {
    n: "4", title: "Uso de datos de salud",
    content: "Los datos de salud:\n\n• Son ingresados de forma voluntaria\n• Se usan exclusivamente con fines informativos\n• No son compartidos con terceros\n• No son utilizados con fines comerciales externos",
    highlight: true,
  },
  {
    n: "5", title: "Confidencialidad y seguridad",
    content: "VitalCross AI implementa medidas razonables de seguridad para proteger la informacion, aunque no puede garantizar seguridad absoluta frente a accesos no autorizados.",
  },
  {
    n: "6", title: "Conservacion de datos",
    content: "Los datos seran conservados mientras el usuario mantenga una cuenta o mientras resulte necesario para brindar el servicio.",
  },
  {
    n: "7", title: "Derechos del usuario",
    content: "El usuario puede:\n\n• Solicitar acceso a sus datos\n• Solicitar rectificacion\n• Solicitar eliminacion\n• Revocar consentimientos\n\nContacto: info@vitalcrossai.com.ar",
    highlight: true,
  },
  {
    n: "8", title: "Transferencias de datos",
    content: "VitalCross AI no vende ni alquila datos personales.\n\nNo se realizan transferencias a terceros sin consentimiento.",
  },
  {
    n: "9", title: "Enlaces externos",
    content: "La Plataforma puede contener enlaces a terceros. VitalCross AI no es responsable por sus politicas de privacidad.",
  },
  {
    n: "10", title: "Cambios en la politica",
    content: "La Politica de Privacidad podra ser modificada. Las actualizaciones se publicaran en el sitio web.",
  },
  {
    n: "11", title: "Contacto",
